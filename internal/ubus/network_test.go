...
func TestBuildWanStatusUnchangedOnExistingFixtures(t *testing.T) {
	...
	for _, tc := range []struct {
		...
		{"active uplink not named wan", dumpRdsActiveWanFailover, true, true, "203.0.113.116", "203.0.113.1"},
		{"single uplink down", dumpSingleWanDown, true, false, "", ""},
		{"both up, only one routed", dumpBothUpOnlyRdsRouted, true, true, "203.0.113.116", "198.51.100.1"},
		{"uplink on a lan-named port", dumpRdsOnLan1WanIsCellular, true, true, "", "198.51.100.1"},

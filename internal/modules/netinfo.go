...
// all, both real on the LBR20). Strips a VLAN suffix (e.g. "lan1.7") to
// match the base port name; returns "" when the active uplink isn't on any
// known physical port (a modem, a bridge, or nothing detected).
